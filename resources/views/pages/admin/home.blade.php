...
<!-- menu sidebar -->
@section('sidebar')
<a href="/admin/home/" class="list-group-item list-group-item-action bg-light">Home</a>
<a href="/admin/lapor/" class="list-group-item list-group-item-action bg-light">Lapor Bahaya</a>
...
<a href="#" class="list-group-item list-group-item-action bg-light">Man Power</a>
@endsection
<!-- end menu sidebar -->
