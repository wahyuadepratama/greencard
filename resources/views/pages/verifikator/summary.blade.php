  ...
  <div class="border p-4 mt-4" style="">
      ...
      <div class="row">
        ...
        <div class="col-sm-3" style="margin: 5px">
          <a id='pdf' href="{{ url('/verifikator/summary/report/export/pdf/2019/02') }}" class="form-control btn btn-primary">
            Download PDF
          </a>
        </div>
        <div class="col-sm-3" style="margin: 5px">
          <a id='excel' href="{{ url('/verifikator/summary/report/export/excel/2019/02') }}" class="form-control btn btn-primary">
            Download Excel
          </a>
        </div>
        <div class="col-sm-3"></div>
...
@section('js-ajax')
  <script type="text/javascript">
    function changeDate() {
      ...
      $('#excel').attr('href', "{{ url('/verifikator/summary/report/export/excel/') }}"+ "/" + year + "/" + month);
      $('#pdf').attr('href', "{{ url('/verifikator/summary/report/export/pdf/') }}"+ "/" + year + "/" + month);
