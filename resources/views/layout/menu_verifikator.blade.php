...
<a href="{{ url('/verifikator/greencard') }}" class="{{ request()->is('verifikator/greencard') ? 'active-btn' : '' }} list-group-item list-group-item-action bg-light"><i class="fa fa-credit-card-alt"></i> Data Greencard</a>
