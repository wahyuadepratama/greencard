<!-- menu sidebar -->
@section('sidebar')
<a href="#" class="list-group-item list-group-item-action bg-light active-btn">Home</a>
...
<a href="#" class="list-group-item list-group-item-action bg-light">Data Man Power</a>
@endsection
<!-- end menu sidebar -->
...
<li class="nav-item collap">
  <a class="nav-link" href="#">Data Man Power</a>
</li>
@endsection
